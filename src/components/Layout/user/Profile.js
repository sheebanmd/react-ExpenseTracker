...
const Profile = () => {
    ...
    fetch('https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyDDZPOILRH5yhGqfI6lkBjY5MA9ECT5BEA',
        {
            method: 'POST',
            body: JSON.stringify({
    ...
    const emailVerification = () => {
        console.log('working');
        fetch('https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyDDZPOILRH5yhGqfI6lkBjY5MA9ECT5BEA',
            {
                method: 'POST',
                body: JSON.stringify({
